			...
			<div class="col-lg-12">
				...
				<div class="card bg-transparent text-white" >
					<div class="card-header font-weight-bold" style="font-size: 20px; background: #1C9CD6;">
						...
						Max Menu Items
						<button class="btn btn-dark text-light float-right">Add New Items</button>
					</div>
						...
						<table id="example" class="table table-bordered text-white" style="width:100%">
							...
							<tbody>
								<tr>
									...
									<td class="text-center"><a href="#" class="text-white"><i class="fas fa-trash-alt text-danger"></i> Delete</a></td>
								</tr>
								<tr>
									<td>Burger</td>
									<td>$200</td>
